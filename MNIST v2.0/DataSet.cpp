...
///////////////////////////////////////////////////////////////////////////////
void get_dataset(Matrix &X,Matrix &Y,char*Xdir,char*Ydir)
{
    //X (28*28,ImagesNUM)
    //Y (10,ImagesNUM)
    ...
    for (uint32_t j=0;j<ImagesNum1;j++)
    {
...
///////////////////////////////////////////////////////////////////////////////
int get_dataset_2D(Volume& X, Matrix &Y,char*Xdir, char*Ydir)
{
	//X Volume(60000)
	//Y (10,ImagesNUM)
	ifstream pixels(Xdir, ios::binary);
	...
	for (uint32_t k = 0; k<ImagesNum1; k++)
	{
