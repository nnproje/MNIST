...
#define matrix_head
using namespace std;
enum MatrixType {Zeros, Identity, Random, Random_Limited, Bernoulli};
...
public:
	...
	matrix* SUM(string choice) const;                    //If choice == "row" , result is 1 x column. If choice == "column", result is row x 1.
	matrix* operator() (string dummy, int r1, int c1, int r2 = -1, int c2 = -1) const; //dummy to be able to overload operator()
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename E>
matrix<E>* matrix<E>::operator() (string PTR ,int r1, int c1, int r2, int c2) const
{
    if (r2 == -1)
        r2 = row - 1;
    if (c2 == -1)
